...
[![Stars](https://img.shields.io/github/stars/MagicSnake0503/Custom_Mihomo_Config?style=flat-square&logo=github&label=Stars&color=2ea44f)](https://github.com/MagicSnake0503/Custom_Mihomo_Config/stargazers)
[![Forks](https://img.shields.io/github/forks/MagicSnake0503/Custom_Mihomo_Config?style=flat-square&logo=github&label=Forks&color=181717)](https://github.com/MagicSnake0503/Custom_Mihomo_Config/network/members)
[![License](https://img.shields.io/github/license/MagicSnake0503/Custom_Mihomo_Config?style=flat-square&color=546e7a)](./LICENSE)
...
```bash
# 克隆仓库
git clone https://github.com/MagicSnake0503/Custom_Mihomo_Config.git
cd Custom_Mihomo_Config

# 或直接下载配置文件
wget https://raw.githubusercontent.com/MagicSnake0503/Custom_Mihomo_Config/main/Custom_Mihomo_Config.yaml
```
...
**解决**: 
- 配置已**关闭懒加载**，延迟检测后会自动切换
- 如果仍不切换，检查延迟差距是否超过容差值（50ms）
- 详见 [关闭懒加载配置说明.md](./关闭懒加载配置说明.md)
...
| `优化说明.md` | 国内网站加速优化详情 |
| `审查报告.md` | 配置审查报告 |
| `关闭懒加载配置说明.md` | 自动测速切换说明 |
| `GitHub发布指南.md` | GitHub 发布教程 |
| `LICENSE` | MIT 开源协议 |
...
- 提交 [Issue](https://github.com/MagicSnake0503/Custom_Mihomo_Config/issues) 反馈问题
